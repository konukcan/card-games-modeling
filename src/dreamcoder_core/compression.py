...
Phase 5 - Recognition-Guided Compression:
  22. compute_recognition_score() - forward-looking score from recognition model
  23. compress_frontiers_recognition() - combined backward+forward scoring
  24. Based on DreamDecompiler (Palmarini et al., ICML 2024)
""")


# ============================================================================
# PHASE 5: RECOGNITION-GUIDED COMPRESSION (DreamDecompiler)
# ============================================================================
"""
Recognition-Guided Compression based on DreamDecompiler (Palmarini et al., ICML 2024).
