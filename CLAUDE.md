...
| Rules catalogue (DreamCoder wake-sleep) | `src/rules/catalogue.py` (CompositionNode trees, legacy subset — see gallery_rules for authoritative count) |
| Rules catalogue (MCMC/gallery analysis) | `src/gallery_analysis/gallery_rules.py` (61 rules, Python port of JS gallery — matches human experiment) |
